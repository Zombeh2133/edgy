...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const Consensus::Params& params) {
    /* current difficulty formula, edgy - DarkGravity v3, written by Evan Duffield - evan@edgy.org */
    ...
    int64_t nTargetTimespan = nPastBlocks * (pindexLast->nHeight > 200 ? params.nPowTargetSpacing : params.nPowTargetSpacingSlowLaunch);
