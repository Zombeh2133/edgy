...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 2000 XDG, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 2000 XDG - checking if valid masternode)
