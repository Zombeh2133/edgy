...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 2000;        // 2000 XDG
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 1518228000;// OFF
