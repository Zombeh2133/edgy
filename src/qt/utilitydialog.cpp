    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("EDGY Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About EDGY Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  edgy-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the EDGY in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XDG, 0.1 XDG, 1 XDG and 10 XDG -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://edgypay.atlassian.net/wiki/display/DOC/PrivateSend\">https://edgypay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("EDGY Core is shutting down...") + "<br /><br />" +
