    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("EDGY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EDGY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and edgy: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About EDGY Core"), this);
    aboutAction->setStatusTip(tr("Show information about EDGY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EDGY Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EDGY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EDGY addresses"));
    ...
    openAction->setStatusTip(tr("Open a edgy: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EDGY Core help message to get a list with possible EDGY Core command-line options"));
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        imageLogo->setPixmap(QPixmap(":/images/" + theme + "/logo"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("EDGY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EDGY network", "", count));
    } else {
...
{
    QString strTitle = tr("EDGY Core"); // default title
