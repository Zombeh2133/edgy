...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("EDGY Core edgy-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  edgy-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded edgy transaction") + "\n" +
              "  edgy-tx [options] -create [commands]   " + _("Create hex-encoded edgy transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded edgy transaction
