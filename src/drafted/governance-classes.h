 ...
 *
 *   // network
 *   CEDGYNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.edgy.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEDGYNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EDGYNetwork
// //   -- signature requirements : Key1(User)
// class CEDGYNetworkVariable : public CGovernanceObject
// {
// private:
