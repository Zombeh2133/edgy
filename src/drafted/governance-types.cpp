...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EDGYNetwork") type = EDGYNetwork;
    if(strType == "EDGYNetworkVariable") type = EDGYNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EDGYNetwork) s = "EDGYNetwork";
    if(type == EDGYNetworkVariable) s = "EDGYNetworkVariable";
