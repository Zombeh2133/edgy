...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all EDGY related functionality
...
/*
    ...
    allow endless transaction that would bloat EDGY and make it unusable. To
